...
- **Output:** 24 kHz samples; MotionGram wraps synthesis as **in-memory WAV** via `soundfile` for pydub / PyAV.

## Public API (sketch)

```python
from motiongram import Scene, VoiceOver, KittenVoiceOverBackend
