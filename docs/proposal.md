...
MotionGram is a proposed lightweight Python animation engine designed as an alternative to ManimCE for educational content creation.
...
By replacing heavy dependencies (LaTeX, Cairo, disk-based rendering pipeline), MotionGram aims to deliver equivalent educational animation quality with drastically lower overhead.
...
MotionGram fixes this with a flat, typed API.
...
| MotionGram     | Python   | ~80 MB  | 2–5s       | Typst/SVG      | High         | Edu animations    |
