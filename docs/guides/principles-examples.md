...
```bash
cd /path/to/MotionGram
python examples/principles/04_value.py
# produces examples/principles/04_value.mp4
```

Requires the same setup as the rest of MotionGram ([Setup Guide](setup.md)): editable install, skia-python, PyAV, optional Typst for math-heavy scenes.
