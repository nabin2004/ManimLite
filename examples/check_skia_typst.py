...
def main() -> int:
    parser = argparse.ArgumentParser(description="Verify MotionGram Skia + Typst pipeline.")
    parser.add_argument(
        "--mp4",
        action="store_true",
    ...
    failed = False
    print("MotionGram pipeline check\n")
    ...
    print("\n3. MotionGram: typst cache + SkiaRenderer")
    ...
    if args.mp4:
        ...
        from motiongram.core import Circle
