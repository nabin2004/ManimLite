...
from typmotion.composition import GoldenSpiral, RuleOfThirdsGrid
...
def build_scene() -> Scene:
    ...
    scene.add_node(Ellipse(x=WIDTH / 3, y=HEIGHT / 3, rx=46, ry=46, fill_color="#F0C060", stroke_color="#FFFFFF", stroke_width=2.0))
    return scene
