...
def build_scene() -> Scene:
    ...
    bg = Node()
    for _, (dx, col) in enumerate([(0, "#242D42"), (140, "#2F3850"), (280, "#3A4462")]):
        bg.add(Rectangle(x=120.0 + dx, y=180.0, width=110.0, height=220.0, corner_radius=14.0, fill_color=col, stroke_color="#4B5876", stroke_width=1.0))
    hero = Ellipse(x=480, y=300, rx=95, ry=95, fill_color="#F0C060", stroke_color="#FFFFFF", stroke_width=3.0)
    scene.add_node(bg)
    scene.add_node(hero)
