...
Many tutorials teach “export PNGs then ffmpeg.” That violates Typmotion’s I/O and subprocess constraints. The right mental model is **streaming memory to an encoder** (PyAV, Phase 074).
